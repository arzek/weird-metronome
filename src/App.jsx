...
class App extends Component {
  ...
  componentDidUpdate() {
    ...
    // Єдина точка входу, запустити можна будь-де
    metronome(run, beat, bmp, count => {
      console.log(count)
    });
  }
      ...
      <main>
        <Card>
          ...
          <CardBody>
            ...
            <Select beat={beat} handleChange={e => this.handleChange('beat', e)} />
          </CardBody>
          <CardFooter>
...
export default connect(state => ({ ...state }), dispatch => ({
  changeField: (key, value) => dispatch({
